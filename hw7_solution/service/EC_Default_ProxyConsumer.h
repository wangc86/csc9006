...
{
public:
  static OurSingletonWorker *getInstance () {
    if(uniqueInstance == NULL) {
      uniqueInstance = new OurSingletonWorker ();
    }
  ...
  // Our FIFO queue
  std::queue<RtecEventComm::EventSet> FIFOQ;
  pthread_mutex_t mtx_FIFOQ;
  bool FIFOQ_nonempty;
  bool nonEmptyFIFOQ (void);
