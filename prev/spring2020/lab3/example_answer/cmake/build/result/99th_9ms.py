...
# set the y-axis range to make sure that at least
#   (1) the topic period is visible on the axis
#   (2) the maximum value of data is visible (i.e., not chopped)
ax1.set_ylim(0,10000)

ax1.set_xlabel('Number of middle-rate topics')
ax1.set_ylabel('99th percentile of the\nend-to-end response time (us)')
ax1.set_title('Topics of 9 ms period')
